...
exports.deletePlat = exports.putPlat = exports.postPlat = exports.getPlatsById = exports.getPlatsByType = exports.getPlats = void 0;
exports.getPlats = {
    tags: ['Plat'],
                ...
                'application/json': {
                    schema: {
                        ...
                        properties: {
                            ...
                            description: {
                                type: 'string',
                                example: "Un hamburger, ou par aphérèse burger, est un sandwich d'origine allemande, composé de deux pains de forme ronde généralement garnis de steak haché et de crudités, salade, tomate, oignon, cornichon, et de sauce…",
                            },
                            plats: {
                                type: 'array',
                                example: [
...
//# sourceMappingURL=plats.swagger%20copy.js.map